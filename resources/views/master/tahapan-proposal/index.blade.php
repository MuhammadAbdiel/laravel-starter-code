                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="form-group form-group-sm row text-sm mb-0">
                                        ...
                                        <div class="col-md-4">
                                            <select class="form-control form-control-sm w-100 filter_combobox filter_department">
                    ...
                    },
                    {
                        ...
                        "mRender": function(data, type, row, meta) {
                            ...
                            $.each(data.split(','), function (i, v) {
                                h += '<span class="badge badge-primary opacity-75 mr-1">'+v+'</span>';
                            });
                            return h;
                        }
                    },
                    {
                        "mData": "tahapan_proposal",
                        "sClass": "",
                        "sWidth": "6%",
                        "bSortable": true,
                        "bSearchable": true
